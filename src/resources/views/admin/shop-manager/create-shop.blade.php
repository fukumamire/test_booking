...
<form action="{{ route('shop-manager.shops.store') }}" method="POST" class="create-shop-form" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <input type="text" id="genres" name="genres" class="form-input" placeholder="例: 寿司, 焼肉, イタリアン" required>
    <small class="form-text text-muted">カンマ区切りで複数のジャンルを入力してください。</small>
</div>
